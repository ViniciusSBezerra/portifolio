...
export const OpenMenu = () => {
  ...
  return (
    <div
      className={`${!theme ? "w-full h-full z-50 fixed right-0 top-0 bg-white" : "w-full h-full z-50 fixed right-0 top-0 bg-dark"}`}
    >
      <ul>
        <OptionMenu closeMenu={false} name="Projetos" href="#projects" />
